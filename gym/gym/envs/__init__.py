...
for reward_type in ['sparse', 'dense']:
    ...
    register(
        id='FetchPushWithObstacle{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchPushWithObstacleEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )

    register(
        id='FetchPushWithStaticObstacles{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchPushWithStaticObstaclesEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )

    register(
        id='FetchReachAmongObstacles{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchReachAmongObstaclesEnv',
        kwargs=kwargs,
        max_episode_steps=100,
    )
    ...
    register(
        ...
        kwargs=_merge({'target_position': 'ignore',
                       'target_rotation': 'z', 'touch_get_obs': 'boolean'}, kwargs),
        max_episode_steps=100,
    )
    ...
    register(
        ...
        entry_point='gym.envs.robotics:HandBlockTouchSensorsEnv',
        kwargs=_merge({'target_position': 'ignore',
                       'target_rotation': 'parallel', 'touch_get_obs': 'boolean'}, kwargs),
        max_episode_steps=100,
    )
    ...
    register(
        ...
        entry_point='gym.envs.robotics:HandBlockTouchSensorsEnv',
        kwargs=_merge({'target_position': 'ignore',
                       'target_rotation': 'xyz', 'touch_get_obs': 'boolean'}, kwargs),
        max_episode_steps=100,
    )
