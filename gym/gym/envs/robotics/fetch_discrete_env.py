...
from gym.envs.robotics import rotations, robot_discrete_env, utils
...
class FetchDiscreteEnv(robot_discrete_env.RobotDiscreteEnv):
    ...
    def __init__(
        ...
        has_object, target_in_the_air, target_offset, obj_range, target_range,
            distance_threshold, initial_qpos, reward_type, n_bins=3,
            has_obstacle=False, immovable_obstacles=False, movable_obstacles=False,
            has_static_obstacles=False, num_static_obstacles=2
    ):
        ...
        self.n_bins = n_bins
        assert self.n_bins % 2 == 1, 'Number of bins should be odd'
        ...
        super(FetchDiscreteEnv, self).__init__(
            model_path=model_path, n_substeps=n_substeps, n_actions=4,
            initial_qpos=initial_qpos, n_bins=n_bins)
    ...
    def render(self, mode='human', width=500, height=500):
        return super(FetchDiscreteEnv, self).render(mode, width, height)
