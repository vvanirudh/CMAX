...
from odium.agents.polo_rts_agent.arguments import get_args
from odium.agents.polo_rts_agent.polo_rts_agent import polo_rts_agent
...
def launch(args):
    ...
    polo_rts_trainer = polo_rts_agent(args, env, env_params, controller)
    polo_rts_trainer.learn()
