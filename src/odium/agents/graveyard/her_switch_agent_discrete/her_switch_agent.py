...
from odium.agents.her_switch_agent.replay_buffer import replay_buffer
from odium.agents.her_switch_agent.models import actor, critic_with_switch
from odium.utils.mpi_utils.normalizer import normalizer
from odium.agents.her_switch_agent.her_sampler import her_sampler
            ...
            for _ in range(self.env_params['max_timesteps']):
                ...
                with torch.no_grad():
                    ...
                    if switch_actions == 0:
                        ...
                        actions = self.controller.act(observation)
                    else:
                        # Learned controller
