...
from odium.agents.her_residual_agent.replay_buffer import replay_buffer
from odium.agents.her_residual_agent.models import actor, critic
from odium.utils.mpi_utils.normalizer import normalizer
from odium.agents.her_residual_agent.her_sampler import her_sampler
...
class her_residual_agent:
    def __init__(self, args, env, env_params):
        ...
        self.her_module = her_sampler(
            self.args.replay_strategy, self.args.replay_k, self.env.compute_reward, self.env.extract_features)
    ...
    def _update_normalizer(self, episode_batch):
        mb_obs, mb_ag, mb_g, mb_actions, mb_f = episode_batch
    ...
    def _update_network(self):
        ...
        f_norm = self.f_norm.normalize(f)
        f_next_norm = self.f_norm.normalize(f_next)
        inputs_norm = f_norm
        inputs_next_norm = f_next_norm
