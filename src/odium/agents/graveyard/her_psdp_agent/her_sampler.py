...
class residual_her_sampler:
    ...
    def sample_her_transitions(self, episode_batch, batch_size_in_transitions, time_step):
        ...
        # FIX: t_samples are fixed to time_step
        t_samples = np.ones(batch_size, dtype=int) * time_step
