...
class her_sampler:
    def __init__(self, replay_strategy, replay_k, reward_func=None, extract_features_func=None):
    ...
    def sample_her_transitions(self, episode_batch, batch_size_in_transitions):
        ...
        transitions['f'] = np.array([self.extract_features_func(
            transitions['obs'][i], transitions['g'][i]) for i in range(batch_size)])
        transitions['f_next'] = np.array([self.extract_features_func(
