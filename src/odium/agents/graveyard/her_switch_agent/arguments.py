...
def get_args():
    ...
    parser.add_argument('--env-name', type=str,
                        default='FetchPickAndPlace-v1', help='the environment name')
    ...
    parser.add_argument('--lr-switch', type=float, default=0.001,
                        help='the learning rate of the switch')
    parser.add_argument('--switch-noise-eps', type=float, default=0.1,
                        help='Exploration probability for the switch network')
    # parser.add_argument('--dueling', type=bool, default=True,
    #                     help='Use dueling architecture for switch network')
    # parser.add_argument('--double_net', type=bool, default=True,
    #                     help='Use double network architecture for switch network')
